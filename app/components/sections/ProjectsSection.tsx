...
const ProjectsSection = () => {
  ...
  return (
    <section id="projects" className="section-shell">
      ...
      <h2 className="section-title">Recent launches across property, travel, and business services.</h2>
      <p className="section-copy">A curated selection of live websites I have built or contributed to.</p>

        <div className="mt-10 grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {projects.map((project, index) => (
            <article key={project.name} className="card-paper group overflow-hidden transition-transform duration-300 hover:-translate-y-1">
              ...
              <div className="p-5">
                <div className="mb-4 flex items-center justify-between gap-2">
                  <span className="rounded-full border border-[#1515151f] bg-white/80 px-3 py-1 text-sm text-[#3f3d39]">
                    {project.category}
                  </span>
                  <svg className="h-5 w-5 text-[#5b5853]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a 
                  ...
                  className="block rounded-full bg-[#151515] px-4 py-3 text-center text-sm font-semibold uppercase tracking-[0.08em] text-white transition-colors hover:bg-[#2a2a2a]"
                >
                  Visit Website
                </a>
              </div>
